...
var registerSourceHandler = function (videojs) {
     ...
     */
    var isSafari = /Mac.*Safari/i.test(navigator.userAgent) ||
    ...
    /**
     * Tells if the browser supports HLS natively.
     *
     * iOS/iPadOS/macOS Safari/Android are considered with native support.
     */
    var nativeHlsSupported = isAndroid || (isSafari && isChrome === false);

    if (Hlsjs.isSupported() && nativeHlsSupported === false) {
        var html5;
