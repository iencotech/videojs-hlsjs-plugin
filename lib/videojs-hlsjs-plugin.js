...
var registerSourceHandler = function (videojs) {
    ...
    /**
     * Tells if Native HLS will be used.
     *
     * We use native for iOS/iPadOS/macOS Safari.
     */
    var useNativeHls = (isSafari && isChrome === false);

    if (Hlsjs.isSupported() && useNativeHls === false) {
        var html5;
